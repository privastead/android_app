...
@Database(entities = [Camera::class, Video::class], version = 1)
abstract class CameraRoomDatabase : RoomDatabase() {

    abstract fun cameraDao(): CameraDao

    companion object {
        @Volatile
        private var INSTANCE: CameraRoomDatabase? = null
